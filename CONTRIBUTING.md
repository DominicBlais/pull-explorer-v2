## Contributing to Pull Explorer v2

♥ [Pull Explorer v2](https://www.github.com/DominicBlais/pull-explorer-v2) and want to get involved? Thanks!
...
The [issue tracker](https://github.com/DominicBlais/pull-explorer-v2/issues) is the preferred channel
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure
   ...
   git clone https://github.com/<your-username>/pull-explorer-v2.git
   # Navigate to the newly cloned directory
   cd pull-explorer-v2
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/DominicBlais/pull-explorer-v2.git
   ```
